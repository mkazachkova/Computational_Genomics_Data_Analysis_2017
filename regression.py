...
#--Lasso--
#print "Starting lasso model"
lasso1 = linear_model.Lasso()
lasso1_fit = lasso1.fit(snp_result_train, y_train)
lasso2 = linear_model.Lasso()
lasso2_fit = lasso2.fit(gene_result_train, y_train2)
...
#print "Starting support vector regression model"
svr1 = SVR()
svr1_fit = svr1.fit(snp_result_train, y_train)
svr2 = SVR()
svr2_fit = svr2.fit(gene_result_train, y_train2)
